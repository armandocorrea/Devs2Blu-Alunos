...
begin
  ...
  case pIdade of
    ...
    5..7: // Caso a idade seja entre 5 a 7 anos
      showMessage('Você é (Infantil A) Idade: ' + IntToStr(pIdade));

    8..10: // Caso a idade seja entre 8 a 10 anos
      showMessage('Você é (Infantil B) Idade: ' + IntToStr(pIdade));

    11..13: // Caso a idade seja entre 11 a 13 anos
      showMessage('Você é (Juvenil A) Idade: ' + IntToStr(pIdade));

    14..17: // Caso a idade seja entre 14 a 17 anos
      showMessage('Você é (Juvenil B) Idade: ' + IntToStr(pIdade));

    18..25: // Caso a idade seja entre 18 a 25 anos
      showMessage('Você é (Sênior) Idade: ' + IntToStr(pIdade));

    else  // Caso a idade não estiver dentre essas opções
